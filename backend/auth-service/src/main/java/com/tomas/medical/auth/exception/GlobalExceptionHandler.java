...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(IncompletePasswordUpdateException.class)
    public ResponseEntity<ApiErrorResponse> handleIncompletePasswordUpdate(IncompletePasswordUpdateException ex,
                                                                           HttpServletRequest request) {
        return buildError(HttpStatus.BAD_REQUEST, ex.getMessage(), request.getRequestURI());
    }
